...
#define MQTT_HOST           "183.240.93.17" //"192.168.99.243"//// the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            1883    // the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID       "client123"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
#define MQTT_USER            "mqtt_xyl/pm25" //"admin"// your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
#define MQTT_PASS            "p2D02sCo2Zk1t0dSNebih8HhtgYQBpChOb6kVyhyyic=" // "public"//you MQTT login password, same as above
...
#define PUBLISH_TOPIC  "/xylmqtt/pm25"
